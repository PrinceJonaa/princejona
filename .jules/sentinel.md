...
**Vulnerability:** Found multiple critical/high vulnerabilities in Next.js version 15.2.4 (pinned in package.json). These included Cache Key Confusion, Content Injection, and SSRF risks (CVE-2024-xxx).
