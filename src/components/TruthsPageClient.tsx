...
import styles from "../app/truths/TruthCard.module.css"; // Adjust path
import { scalePop } from "../animations/core"; // Adjust path

// Define truths here or pass as props
const truths = [
...
// TruthCard component definition moved here
...
// Main Client Component for the Truths page UI
export default function TruthsPageClient() {
